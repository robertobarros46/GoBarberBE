...
class AppointmentController {
  ...
  async store(req, res) {
    ...
    if (!(await schema.isValid(req.body))) {
      return res.status(400).json({ error: 'Valdiation failed' });
    }
    ...
    /**
     * Check if provider is making appointment with self
     */
    ...
    /**
     * Converts date in date format accepted by method startOfHour
     */
